...
process.TFileService = cms.Service("TFileService", fileName = cms.string('L1TrkNtuple_TruncatedNONE_10events_dispSUSY.root'), closeFileFast = cms.untracked.bool(True))
