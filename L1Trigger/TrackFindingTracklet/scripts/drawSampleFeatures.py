...
myFile = files['MP']
tree = myFile.Get('L1TrackNtuple/eventTree')
...
histLabels = {
    'tp_d0': "Tracking particle; d_0 [cm]; Events"
}

# myVar = 'tp_d0'
myVar = 'match_tp_d0'

myHist = ROOT.TH1F(histNames[myVar], histLabels[myVar], 100, -10, 10)

tree.Project(histNames[myVar], myVar)

canvas = ROOT.TCanvas("c1", "Histogram", 900, 600)
myHist.Draw()
canvas.Draw()
canvas.SaveAs("sample_matchtpd0_mp.pdf")
