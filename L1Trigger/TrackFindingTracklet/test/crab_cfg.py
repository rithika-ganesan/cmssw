...
config.General.requestName = 'algo_HYBRID-nevents_50000-sample_HTo2LongLivedTo4mu_MH-125_MFF-25_CTau-1500mm-dr_truncated'
...
config.JobType.maxMemoryMB = 8000                      ## increase of the default mem request as these jobs are quite heavy


config.Data.inputDataset = '/HTo2LongLivedTo4mu_MH-125_MFF-25_CTau-1500mm_TuneCP5_14TeV-pythia8/Phase2Spring24DIGIRECOMiniAOD-PU200_Trk1GeV_140X_mcRun4_realistic_v4-v1/GEN-SIM-DIGI-RAW-MINIAOD'
